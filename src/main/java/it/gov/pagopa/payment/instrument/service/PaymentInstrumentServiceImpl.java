...
public class PaymentInstrumentServiceImpl implements PaymentInstrumentService {
  ...
  public void deactivateInstrument(String initiativeId, String userId,
    ...
    if(instrument.getInstrumentType().equals(PaymentInstrumentConstants.INSTRUMENT_TYPE_COUPON_PAYMENT)){
      throw new PaymentInstrumentException(403, "It's not possible to delete an instrument of Coupon types");
    }
